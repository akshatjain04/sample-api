...
public class instructionsPostTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/springframework/RoostTest/instructionsPostTest.csv", envVarsList);
	}
		...
		for (Map<String, String> testData : envList) {
			...
			Response responseObj = given()
				...
				.body("{\n" + "  \"merchantInstructionIdentification\": \""
						+ (testData.get("merchantInstructionIdentification") != null
								? testData.get("merchantInstructionIdentification") : "")
						+ "\",\n" + "  \"mandateIdentification\": \""
						+ (testData.get("mandateIdentification") != null ? testData.get("mandateIdentification") : "")
						+ "\",\n" + "  \"debtorName\": \""
						...
						+ (testData.get("instructedAmountCurrency") != null ? testData.get("instructedAmountCurrency")
								: "")
						+ "\",\n" + "  \"instructedAmount\": \""
						+ (testData.get("instructedAmount") != null ? testData.get("instructedAmount") : "") + "\",\n"
						+ "  \"remittanceInformation\": \""
						+ (testData.get("remittanceInformation") != null ? testData.get("remittanceInformation") : "")
						+ "\",\n" + "  \"smsLanguageCode\": \""
			...
			if (responseObj.statusCode() == 201) {
				...
				if (response.get("paymentInformationStatus") != null) {
					...
					MatcherAssert.assertThat(response.getString("paymentInformationStatus"),
							anyOf(equalTo("ACSC"), equalTo("RJCT"), equalTo("ACCP"), equalTo("ACSP")));

					MatcherAssert.assertThat(response.getString("paymentInformationStatus").length(),
							lessThanOrEqualTo(4));
				...
				if (response.get("transactionIdentification") != null) {
					...
					MatcherAssert.assertThat(response.getString("transactionIdentification").length(),
