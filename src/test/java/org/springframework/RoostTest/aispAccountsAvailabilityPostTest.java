...
public class aispAccountsAvailabilityPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src\\test\\java\\org\\springframework\\RoostTest\\aisp_accounts_availabilityPostTest.csv", envVarsList);
    }

  
    @Test  
    public void aispAccountsAvailabilityPost_Test() throws org.json.JSONException {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0";  
				...
				.body("{\n"+
					...
					"  \"shareCompanyName\": \"" + (testData.get("shareCompanyName") != null ? testData.get("shareCompanyName") : "") + "\n" +
 				"}")
              ...
              if (response.get("data["+ i +"].paramName") != null) {  
                ...
                MatcherAssert.assertThat(response.getString("data["+ i +"].paramName"), anyOf(equalTo("businessRegistrationCertificate"), equalTo("certificateOfIncorporation"), equalTo("accountNumber"), equalTo("other")));
              ...
              if (response.get("data["+ i +"].companyName") != null) {  
                MatcherAssert.assertThat(response.get("data["+ i +"].companyName"), instanceOf(String.class));  
          }
