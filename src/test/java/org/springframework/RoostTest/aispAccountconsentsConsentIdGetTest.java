...
public class aispAccountconsentsConsentIdGetTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {"consentId"};
      envList = dataloader.load("src\\test\\java\\org\\springframework\\RoostTest\\aisp_account-consents_consentIdGetTest.csv", envVarsList);
    }

  
    @Test  
    public void aispAccountconsentsConsentIdGet_Test() throws org.json.JSONException {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0";  
              ...
              if (response.get("data.balanceFromDate") != null) {  
                MatcherAssert.assertThat(response.get("data.balanceFromDate"), instanceOf(String.class));  
          }
      
              if (response.get("data.balanceToDate") != null) {  
                MatcherAssert.assertThat(response.get("data.balanceToDate"), instanceOf(String.class));  
          }
