...
public class otpconfirmationPostTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/springframework/RoostTest/otpconfirmationPostTest.csv",
				envVarsList);
	}
		...
		for (Map<String, String> testData : envList) {
			...
			Response responseObj = given()
				...
				.body("{\n" + "  \"mandateIdentification\": \""
						...
						+ (testData.get("otpIdentificationNumber") != null ? testData.get("otpIdentificationNumber")
								: "")
						+ "\",\n" + "  \"otpPassword\": \""
						+ (testData.get("otpPassword") != null ? testData.get("otpPassword") : "") + "\",\n"
						+ "  \"creditorAccount\": \""
