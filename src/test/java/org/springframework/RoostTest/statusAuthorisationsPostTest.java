...
public class statusAuthorisationsPostTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/springframework/RoostTest/status_authorisationsPostTest.csv",
				envVarsList);
	}
		...
		for (Map<String, String> testData : envList) {
			...
			if (responseObj.statusCode() == 201) {
				...
				if (response.get("mandateStatus") != null) {
					...
					MatcherAssert.assertThat(response.getString("mandateStatus"),
							anyOf(equalTo("ERROR"), equalTo("PDOU"), equalTo("ACTIVE"), equalTo("EXPIRED"),
									equalTo("DORMANT"), equalTo("SUSPENDED"), equalTo("CANCELLED"), equalTo("DELETED"),
									equalTo("PDNG"), equalTo("PDFP")));
