...
public class reportsPostTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/springframework/RoostTest/reportsPostTest.csv", envVarsList);
	}
	...
	public void reportsPost_Test() throws JSONException {
		...
		for (Map<String, String> testData : envList) {
			...
			Response responseObj = given()
				...
				.body("{\n" + "  \"reportType\": \""
						+ (testData.get("reportType") != null ? testData.get("reportType") : "") + "\",\n"
						+ "  \"reportingDate\": \""
						+ (testData.get("reportingDate") != null ? testData.get("reportingDate") : "") + "\",\n"
						+ "  \"creditorAccount\": \""
