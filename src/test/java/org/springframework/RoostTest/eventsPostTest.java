...
public class eventsPostTest {
    ...
    public void setUp() {
      ...
      String[] envVarsList = {""};
      envList = dataloader.load("src\\test\\java\\org\\springframework\\RoostTest\\eventsPostTest.csv", envVarsList);
    }

  
    @Test  
    public void eventsPost_Test() throws org.json.JSONException {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0";  
				...
				.body("{\n"+
					"  \"ack\": \"" + (testData.get("ack") != null ? testData.get("ack") : "") + "\",\n" +
					"  \"returnImmediately\": \"" + (testData.get("returnImmediately") != null ? testData.get("returnImmediately") : "") + "\",\n" +
					"  \"maxEvents\": \"" + (testData.get("maxEvents") != null ? testData.get("maxEvents") : "") + "\n" +
 				"}")
