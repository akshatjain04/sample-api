...
public class aispAccountsAccountIdTransactionsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src\\test\\java\\org\\springframework\\RoostTest\\aisp_accounts_accountId_transactionsGetTest.csv", envVarsList);
    }

  
    @Test  
    public void aispAccountsAccountIdTransactionsGet_Test() throws org.json.JSONException {
        this.setUp();
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0";  
              ...
              if (response.get("data.transaction["+ i +"].transactionId") != null) {  
                MatcherAssert.assertThat(response.get("data.transaction["+ i +"].transactionId"), instanceOf(String.class));  
          }
