...
public class directdebitconsentsPostTest {
	...
	public void setUp() {
		...
		envList = dataloader.load("src/test/java/org/springframework/RoostTest/direct-debit-consentsPostTest.csv",
				envVarsList);
	}
		...
		for (Map<String, String> testData : envList) {
			...
			switch (responseObj.statusCode()) {
				...
				case 201:
					...
					MatcherAssert.assertThat(contentType, equalTo("text/xml"));
					break;
