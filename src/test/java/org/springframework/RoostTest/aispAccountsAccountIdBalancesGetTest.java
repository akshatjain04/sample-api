...
import io.restassured.RestAssured;,import io.restassured.path.json.JsonPath;,import io.restassured.http.ContentType;,import io.restassured.response.Response;,import org.junit.Before;,import org.junit.jupiter.api.Test;,import static io.restassured.RestAssured.given;,import static org.junit.Assert.*;,import java.io.BufferedReader;,import java.io.File;,import java.io.IOException;,import java.util.HashMap;,import java.util.Map;,import java.util.ArrayList;,import java.util.List;,import org.hamcrest.MatcherAssert;,import static org.hamcrest.Matchers.*;,import org.slf4j.Logger;,import org.slf4j.LoggerFactory;,import org.json.JSONObject;,import org.json.XML;,import org.json.JSONException;,import org.json.JSONArray;
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://sandbox.ob.business.hsbc.com.hk/mock/open-banking/v1.0";  
              ...
              if (response.get("data.account["+ i +"].accountId") != null) {    
                MatcherAssert.assertThat(response.getString("data.account["+ i +"].accountId"), matchesPattern("undefined")); 
              ...
              if (response.get("data.account["+ i +"].balance["+ i1 +"].type") != null) {    
                MatcherAssert.assertThat(response.getString("data.account["+ i +"].balance["+ i1 +"].type"), matchesPattern("undefined")); 
              ...
              if (response.get("data.account["+ i +"].balance["+ i1 +"].creditDebitIndicator") != null) {    
                MatcherAssert.assertThat(response.getString("data.account["+ i +"].balance["+ i1 +"].creditDebitIndicator"), matchesPattern("undefined")); 
              ...
              if (response.get("data.account["+ i +"].balance["+ i1 +"].datetime") != null) {    
                MatcherAssert.assertThat(response.getString("data.account["+ i +"].balance["+ i1 +"].datetime"), matchesPattern("undefined")); 
              ...
              if (response.get("links.self") != null) {    
                MatcherAssert.assertThat(response.getString("links.self"), matchesPattern("undefined")); 
  
                MatcherAssert.assertThat(response.get("links.self"), instanceOf(String.class));  
          }
      
              if (response.get("links.prev") != null) {    
                MatcherAssert.assertThat(response.getString("links.prev"), matchesPattern("undefined")); 
  
                MatcherAssert.assertThat(response.get("links.prev"), instanceOf(String.class));  
          }
      
              if (response.get("links.next") != null) {    
                MatcherAssert.assertThat(response.getString("links.next"), matchesPattern("undefined")); 
...
if (responseObj.statusCode() == 400) {
              ...
              if (response.get("id") != null) {    
                MatcherAssert.assertThat(response.getString("id"), matchesPattern("undefined")); 
              ...
              if (response.get("errors["+ i +"].code") != null) {    
                MatcherAssert.assertThat(response.getString("errors["+ i +"].code"), matchesPattern("undefined")); 
  
                MatcherAssert.assertThat(response.get("errors["+ i +"].code"), instanceOf(String.class));  
          }
      
              if (response.get("errors["+ i +"].causes") != null) {    
                MatcherAssert.assertThat(response.getString("errors["+ i +"].causes"), matchesPattern("undefined")); 
              ...
              if (response.get("errors["+ i +"].extendedDetails.path") != null) {    
                MatcherAssert.assertThat(response.getString("errors["+ i +"].extendedDetails.path"), matchesPattern("undefined")); 
...
if (responseObj.statusCode() == 429) {
              ...
              if (response.get("message") != null) {    
                MatcherAssert.assertThat(response.getString("message"), matchesPattern("undefined")); 
